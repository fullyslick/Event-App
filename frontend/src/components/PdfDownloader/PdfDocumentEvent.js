  ...
  return (
    <View style={styles.eventItem} wrap={false}>
      <View style={styles.eventDetails}>
        ...
        <Text style={styles.eventDetailsItem}>
          <Text style={styles.eventLabel}>Type:</Text> {category}
        </Text>
        <Text style={styles.eventDetailsItem}>
          <Text style={styles.eventLabel}>Summary:</Text> {description}
        </Text>
        <Text style={styles.eventDetailsItem}>
          <Text style={styles.eventLabel}>When:</Text> {eventDate}
        </Text>
        <Text style={styles.eventDetailsItem}>
          <Text style={styles.eventLabel}>Starts at:</Text> {eventTime}
        </Text>
        <Text style={styles.eventDetailsItem}>
          <Text style={styles.eventLabel}>Where:</Text> {location} {address}{' '}
        </Text>
        <Text style={styles.eventDetailsItem}>
          <Text style={styles.eventLabel}>Ticket Price:</Text> {displayPrice}{' '}
          {currency}
        </Text>
        <Text style={styles.eventDetailsItem}>
          <Text style={styles.eventLabel}>Total Price:</Text> {totalPrice}{' '}
          {currency}
        </Text>
        <Text style={styles.eventDetailsItem}>
          <Text style={styles.eventLabel}>In wishlist:</Text> {ticketsWishList}
        </Text>
      </View>
