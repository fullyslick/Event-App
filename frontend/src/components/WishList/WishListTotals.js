...
const WishListTotals = () => {
    ...
    return (
        <div className={classes['wishlist-totals']}>
            <p><span className={classes['wishlist-totals--title']}>Total Items:</span>{totalWishList}</p>
            <p><span className={classes['wishlist-totals--title']}>Total Price:</span>{totalPrice}</p>
        </div>
    );
}
