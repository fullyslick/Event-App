    ...
    return (
        <div className={classes['event']}>
            <div className={classes['event__image--frame']}>
                <Image className={classes['event__image']} src={imageOriginal} alt={title} />
            </div>
            <div className={classes['event__details']}>
                ...
                <p>
                    <span className={classes['event__details-label']}>About:</span>{description}
                </p>
                <p>
                    <span className={classes['event__details-label']}>Location:</span>{location} {address}
                </p>
                <p>
                    <span className={classes['event__details-label']}>When:</span>{eventDate}
                </p>
                <p>
                    <span className={classes['event__details-label']}>Starts at:</span>{eventTime}
                </p>
            </div>
            <div className={classes['event__details-actions']}>
                <div className={classes['event__details-actions--availability']}>
                    <p>
                        <span className={`${classes['event__details-label']} ${classes['event__details-label--red']}`}>
                            Tickets left:
                        </span>
                        {availableTickets}
                    </p>
                    <p>
                        <span className={`${classes['event__details-label']} ${classes['event__details-label--blue']}`}>
                            Wish list:
                        </span>
                        {ticketsWishList}
                    </p>
                    <p>
                        <span className={classes['event__details-label']}>Price:</span>{displayPrice} {currency}
                    </p>
                    <hr></hr>
                    <p>
                        <span className={classes['event__details-label']}>Total:</span>{totalPrice}
                    </p>
                </div>
